...
const NavBar = (props) => {
  ...
  const {
    ...
    onOpen: setContactInfoOpen,
    onClose: setContactInfoClosed,
  } = useDisclosure();
    ...
    <>
      ...
      >
        <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
          <HStack>
            <NextLink href={'/'} scroll={false} pt={1}>
              <Box
                display={'inline-flex'}
                alignItems={'center'}
            ...
            <HStack
              ...
              pl={4}
            >
              <LinkElement path={pathname} href={'/projects'}>
                Projects
              </LinkElement>
            </HStack>
          </HStack>
              ...
              <Menu onClose={onClose}>
                ...
                <MenuList alignItems={'center'}>
                  ...
                  <MenuItem onClick={setContactInfoOpen}>
                    <Icon as={FcBusinessContact} /> &nbsp; Contact
                  </MenuItem>
                  <MenuItem onClick={setCVOpen}>
                    <Icon as={FcDiploma2} /> &nbsp; CV
                  </MenuItem>
                  <MenuDivider />
                  <MenuItem
                    onClick={toggleColorMode}
                  ...
                  >
                    {colorMode === 'light' ? (
                      <MoonIcon color={'#5f5fcb'} />
                    ) : (
                      <SunIcon color={'#eebb52'} />
                    )}{' '}
              ...
              <LightMode>
                ...
                <Button
                  ...
                  onClick={function () {
                    ...
                    document.getElementById('work-email-button').innerHTML =
                      `✅&nbsp; Copied!`;
                  }}
                >
                  Work Email
