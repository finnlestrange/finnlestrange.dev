      ...
      <Box pt={5}>
        {linkText != null ? (
          <Link href={link} target={'_blank'}>
            <Button leftIcon={<Icon as={buttonIcon} />}>{linkText}</Button>
          </Link>
        ) : null}
      </Box>
    </Stack>
    ...
    <Box as={Container} maxW="7xl" mt={14} p={4}>
      ...
      >
        ...
        <GridItem>
          <Flex>
            <chakra.p>
              Here are some of my favorite projects. I have a lot more on my
              GitHub profile. Information on closed source projects can be
      ...
      <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10}>
        ...
        <Feature
          ...
          link={
            'https://github.com/InternationalSchoolAberdeen/ISAPowerSchoolPlugins'
          }
        ...
        <Feature
          ...
          link={
            'https://github.com/InternationalSchoolAberdeen/DriveAPIFileUploadJava'
          }
          linkText={'Source Code'}
          buttonIcon={FaGithub}
        />
